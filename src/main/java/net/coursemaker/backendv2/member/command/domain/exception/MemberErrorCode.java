...
public enum MemberErrorCode implements ErrorCode {
	...
	NICKNAME_DUPLICATED("USER-002", "duplicated data", HttpStatus.CONFLICT),
	PHONE_NUMBER_DUPLICATED("USER-003", "duplicated data", HttpStatus.CONFLICT),
	...
	BANNED_MEMBER("USER-009", "banned member", HttpStatus.BAD_REQUEST),;
